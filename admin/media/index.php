                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Do you want to delete this image?');" href="delete.php?id=<?php echo $data['id']; ?>" role="button"><i class="bi bi-trash3-fill"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
